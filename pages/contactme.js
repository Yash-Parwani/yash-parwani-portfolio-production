        ...
        <div className="flex  justify-around mt-10 w-full">
          ...
          <div className="contact-form ">
            ...
            <form ref={form} onSubmit={sendMail}>
              ...
              Submit <span><Image alt="send" src="/images/send.png" width={24} height={24}/></span>
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="Details">
            ...
            <div className="mb-4">
              ...
              <p className="flex justify-center">
                <span className="mr-3">
                  <Image alt="gmail" src="/gmail.png" width="32" height="32" />
                </span>{" "}
            ...
            <div>
              ...
              <Link href="https://www.linkedin.com/in/yash-parwani-5610/"><button className="flex mb-4"><Image alt="linkedin" src="/linkedin.png" width="32" height="32" /><p className="ml-2">Linked-In</p> </button></Link>
              <Link href="https://www.instagram.com/parwani583/"><a target="_blank"  rel="noopener noreferrer"><button className="flex mb-4"><Image alt="instagram" src="/instagram.png" width="32" height="32" /><p className="ml-2">parwani583</p></button></a></Link>

              <Link href="https://github.com/Yash-Parwani"><button className="flex "><Image alt="github" src="/github.png" width="32" height="32" /><p className="ml-2">Github</p></button></Link>
            </div>
          </div>
        </div>
      </section>
