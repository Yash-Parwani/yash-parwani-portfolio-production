...
export async function getServerSideProps(context) {
  // fetches data about me
   ...
   const response = await fetch("https://yash-parwani-portfolio-production.vercel.app/api/aboutme");
   //.json() also returns a promise ,hence async await
   const datajson = await response.json();

   const responsenew = await fetch("https://yash-parwani-portfolio-production.vercel.app/api/projects");
      ...
      <section className="hero-section h-screen col-span-11 grid grid-cols-3 ">
        <article className="col-span-1 h-screen  text-stark">
          <div className="py-20">
            ...
            <p className="max-w-4xl py-8 text-2xl ">
        ...
        <aside className="col-span-2 flex justify-end h-fit">
          <div className="">
            <Image alt="yash" src="/images/yash.png" width={575} height={775}/>
          </div>
        </aside>
      </section>
      {/* projects section */}
