...
export async function getServerSideProps(context) {
  const response = await fetch("https://yash-parwani-portfolio-production.vercel.app/api/skills");
      ...
      <section className=" text-stark h-fit col-span-10 flex flex-col items-center  ">
        <h1 className="  h-fit text-6xl text-center w-max mb-10">
          Resume
                ...
                }}><Image alt="pdf" src="/pdf.png" width={24} height ={24}/> Download Resume</button>
              
        <div >

          <Image alt="resume" src="/Yash-Kishore-Parwani-resume.png" width={2733} height={3867.75}/>
        </div>
